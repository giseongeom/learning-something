...
do {
    ...
    netsh.exe advfirewall firewall add rule name="$rulename-#$icount" dir=in action=allow localip=any remoteip="$textranges" description="$description" profile="$profiletype" interfacetype="$interfacetype"
