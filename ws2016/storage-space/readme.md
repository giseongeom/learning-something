...
PS C:> New-StorageSpaceVolume -diskIds (1..3) -driveLetter E -driveLabel DBDATA1
...
PS C:> New-StorageSpaceVolume -diskIds 3,4 -driveLetter F -driveLabel DBDATA2
$diskIds:  3 4
$diskIds.count:  2
$disks.count:  1
Failed in validating diskIds....

PS C:> New-StorageSpaceVolume -diskIds 4,5 -driveLetter F -driveLabel DBDATA2
...
PS C:> Get-StoragePool -IsPrimordial $false | % { Clear-StoragePool -poolName $_.FriendlyName }
...
```PowerShell
PS C:> Get-DiskCount -PartitionStyle RAW
11

PS C:> Get-DiskCount -PartitionStyle GPT
0

PS C:> Get-DiskCount -PartitionStyle MBR
1
